...
struct QuestionnaireView: View {
    ...
    private var autoMatchingView: some View {
        PhasedProgressView(
            ...
            accentColor: .teal,
            phases: [
                .init(icon: "folder", label: "Projekt wird zugeordnet"),
                .init(icon: "shippingbox", label: "Produkte werden abgeglichen"),
            ],
            recapStats: [
                .init(icon: "folder", value: "\(controller.projects.count)", label: "Projekte"),
                .init(icon: "shippingbox", value: "\(controller.products.count)", label: "Produkte"),
                .init(icon: "tag", value: "\(controller.evaluation.materials.count)", label: "Materialien"),
            ],
            isComplete: false,
