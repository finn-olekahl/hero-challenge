...
struct OfferView: View {
    ...
    private var generatingView: some View {
        PhasedProgressView(
            ...
            accentColor: .orange,
            phases: [
                .init(icon: "text.magnifyingglass", label: "Aufnahme wird analysiert"),
                .init(icon: "wrench.and.screwdriver", label: "Leistungspositionen werden erstellt"),
                .init(icon: "shippingbox", label: "Materialpositionen werden berechnet"),
                .init(icon: "eurosign.circle", label: "Preise werden kalkuliert"),
            ],
            recapStats: [
                .init(icon: "wrench.and.screwdriver", value: "\(controller.evaluation.services.count)", label: "Leistungen"),
                .init(icon: "shippingbox", value: "\(controller.evaluation.materials.count)", label: "Materialien"),
                .init(icon: "questionmark.bubble", value: "\(controller.answers.freeTextAnswers.count + controller.answers.billingMethods.count)", label: "Antworten"),
            ],
            isComplete: !controller.isGenerating && controller.generatedOffer != nil,
